...
export class DataService {
  ...
  constructor() {
    ...
    this.channel_list.push({ id: 3, name: 'Zee Cinema HD', logo: 'assets/Zee_Cinema_HD.png', url: 'http://freeiptv.ga/tv2.php?channel=0-9-zeecinemahd&progid=165', div_width: '1060px',div_height:'600px', iframe_margin_top: '-150px' });
  ...
  public getChannelById(id){
    return this.channel_list.filter(x => x.id == id)[0];
  }
